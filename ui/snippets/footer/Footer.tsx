  ...
  const PAXEER_LINKS = [
    {
      ...
      iconSize: '18px',
      text: 'GitHub',
      url: 'https://github.com/Paxeer-Network',
    },
    {
      icon: 'open-link' as const,
      iconSize: '18px',
      text: 'NPM SDK',
      url: 'https://www.npmjs.com/package/paxeer-ecosystem-sdk',
    },
    {
      icon: 'social/twitter' as const,
      iconSize: '18px',
      text: 'X (Twitter)',
      url: 'https://x.com/paxeernet',
    },
    {
      icon: 'social/telega' as const,
      iconSize: '18px',
      text: 'Telegram',
      url: 'https://t.me/paxcommunity',
    },
    {
      icon: 'share' as const,
      iconSize: '16px',
      text: 'Contact',
      url: 'mailto:infopaxeer@paxeer.app',
    },
  ];
    ...
    return (
      <Box gridArea={ gridArea }>
        <Flex columnGap={ 2 } textStyle="xs" alignItems="center">
          ...
          <Link href="https://paxeer.app" target="_blank" display="inline-flex" alignItems="center">
            <img 
              src="https://storage.googleapis.com/conduit-prd-apps-web-cdn/paxeer-network-djjz47ii4b-946cbaf8-612a-4bb1-a61d-79a82248b113.png"
              alt="Paxeer Network"
        ...
        <Text mt={ 3 } fontSize="xs">
          PaxScan is the official blockchain explorer for Paxeer Network, providing comprehensive transaction and contract analysis.
        </Text>
        <Box mt={ 6 } alignItems="start" textStyle="xs">
          ...
          <Text>
            Copyright { copy } Paxeer LTD 2025
          </Text>
        </Box>
      </Box>
    );
      ...
      <Box { ...containerProps }>
        <Grid { ...contentProps }>
          ...
          >
            {
              ([
                { title: 'Paxeer Network', links: PAXEER_LINKS },
                ...(linksData || []),
              ])
                .slice(0, colNum)
                .map(linkGroup => (
    ...
    <Box { ...containerProps }>
      ...
      >
        ...
        <Grid
          ...
          mt={{ base: 8, lg: 0 }}
        >
          { PAXEER_LINKS.map(link => <FooterLinkItem { ...link } key={ link.text }/>) }
        </Grid>
      </Grid>
    </Box>
  );
